    ...
    return (
        ...
        >
            <Tab.Screen
                ...
                options={{
                    tabBarLabel: () => <Text style={styles.labelTextStyle}>{I18n.t("events")}</Text>,


                }}
                name="AllEventScreen"
                // component={AllEventsScreen} 
                children={(props: any) => <AllEventsScreen searchInput={searchInput} {...props} />}
            />
            {/* <Tab.Screen
                options={{
            ...
            <Tab.Screen
                ...
                children={(props: any) => <InvitEventsScreen searchInput={searchInput} {...props} />}
            />
        </Tab.Navigator>
    );
}
