...
const AddExperienceModal = (props: any) => {
  ...
  const [payload, setPayload] = useState({
    ...
    startDate: editData?.startDate
      ? moment(editData?.startDate)?.toDate()
      : null,
  ...
  return (
    <Modal
      ...
      <View
        ...
        <ScrollView style={[styles.containerStyle, globalStyles.shadow]}>
          ...
          <View style={styles.lineContainerStyle}>
            ...
            <TextInput
              ...
              onChangeText={(institution: string) =>
                setPayload({...payload, institution})
              }
          ...
          <View style={styles.lineContainerStyle}>
            ...
            <TextInput
              ...
              onChangeText={(profession: string) =>
                setPayload({...payload, profession})
              }
              style={styles.textInputStyle}
            />
          </View>
          ...
          <Pressable
            ...
            <TextInput
              ...
              value={
                payload?.startDate
                  ? moment(payload?.startDate).format('ll')
                  : ''
              }
              style={styles.textInputStyle}
            />
          ...
          <Pressable
            ...
            <TextInput
              ...
              editable={false}
              value={
                payload?.endDate ? moment(payload?.endDate).format('ll') : ''
              }
              style={styles.textInputStyle}
            />
          </Pressable>
