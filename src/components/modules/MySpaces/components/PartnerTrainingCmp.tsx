...
const PartnerTrainingCmp = (props: any) => {
  const {data, edit, deleteFormation} = props;
  const refMenu = useRef(null);
  function deleteItem() {
    Alert.alert(I18n.t('delete'), I18n.t('delete_msg'), [
      {
        text: I18n.t('cancel'),
  ...
  return (
    <View style={styles.itemStyle}>
      <View style={styles.itemContainerStyle}>
        <Text
          style={[styles.titleTextStyle, {fontFamily: fonts.type.NunitoBold}]}>
          {data?.institution}
        </Text>
...
export default PartnerTrainingCmp;
