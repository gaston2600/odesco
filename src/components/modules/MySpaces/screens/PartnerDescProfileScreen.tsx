...
import PartnerTrainingCmp from '../components/PartnerTrainingCmp';
      ...
      <View style={styles.titleContainerStyle}>
        <Text
          style={[
            ...
            {fontFamily: fonts.type.NunitoBold, fontSize: fonts.size.font14},
      ...
      {!!data?.skills?.length && (
        <View style={styles.sectionContainerStyle}>
          ...
          <FlatList
            ...
            horizontal
            renderItem={({item}) => (
              <SkillCmp data={item} deleteSkill={deleteSkill} />
            )}
