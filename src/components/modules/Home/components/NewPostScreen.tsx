  ...
  function submit() {
    ...
    dispatch(
      postPost(
        {
          partner:
            selectedSpace?.type === 'Partner' ? selectedSpace?._id : null,
          inst_id:
            selectedSpace?.type === 'Institution' ? selectedSpace?._id : null,
    ...
    <View style={styles.containerStyle}>
      <View style={styles.headerContainerStyle}>
        ...
        <Pressable
          ...
          {loadingNewPost ? (
            <ActivityIndicator color={colors.sereneBlue} />
          ) : (
            <Text
              style={{
        ...
        <Pressable
            ...
            <AvatarCmp
              name={
                selectedSpace?.type === 'Partner'
                  ? selectedSpace?.first_name?.slice(0, 2)
                  : selectedSpace?.name?.slice(0, 2)
              }
          ...
          <View
            ...
            <Text style={styles.titleTextStyle}>
              {selectedSpace?.type === 'Partner'
                ? `${selectedSpace?.first_name} ${selectedSpace?.last_name}`
                : selectedSpace?.name}
            </Text>
          </View>
        </Pressable>
