...
import { getEvents, subscribeEvent } from '../../../../store/actions/eventsActions';
        ...
        <View style={[styles.containerStyle, globalStyles.shadow]}>
            ...
            <View style={[styles.bodyContainerStyle,]} >
                ...
                <View style={styles.rowContainer}>
                    ...
                    <Text style={styles.instTitleTextStyle}>{data?.subscribers?.length}</Text>
                </View>
                <View
                    style={{
                        alignItems: "center",
            ...
            >
                ...
                {data?.is_presential || data?.is_hybrid ? <View style={[styles.statusContainerStyle, { backgroundColor: colors.primary }]}>
            ...
            <SelectInstitutionModal
                ...
                selectedList={data?.subscribers?.map((v: any) => ({ _id: v?._id, type: v?.partner ? "Partner" : "Institution" }))}
            />
        </View>
    )
}
