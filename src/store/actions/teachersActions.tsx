...
import {
  GET_ONE_TEACHER,
  GET_ONE_TEACHER_FAILED,
  GET_ONE_TEACHER_SUCCESS,
  GET_TEACHERS_LIST,
  GET_TEACHERS_LIST_FAILED,
  GET_TEACHERS_LIST_SUCCESS,
  SUBSCRIBE_TO_TEACHER,
  SUBSCRIBE_TO_TEACHER_FAILED,
  SUBSCRIBE_TO_TEACHER_SUCCESS,
} from '../types/teachersActionsType';

export const getTeachersList: any = (
  data: any,
  callback: any,
  callbackError: any,
) => {
...
export const getOneTeacher: any = (
  data: any,
  callback: any,
  callbackError: any,
) => {
...
export const subscribeToTeacher: any = (
  data: any,
  callback: any,
  callbackError: any,
) => {
