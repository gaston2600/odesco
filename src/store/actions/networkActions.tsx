...
import {
  ACCEPT_MEMBER_NETWORK,
  ACCEPT_MEMBER_NETWORK_FAILED,
  ACCEPT_MEMBER_NETWORK_SUCCESS,
  ADD_MEMBER_NETWORK,
  ADD_MEMBER_NETWORK_FAILED,
  ADD_MEMBER_NETWORK_SUCCESS,
  GET_ONE_NETWORK,
  GET_ONE_NETWORK_FAILED,
  GET_ONE_NETWORK_SUCCESS,
} from '../types/networkActionsType';

export const getNetwork: any = (data: any) => {
...
export const acceptMemberNetwork: any = (
  data: any,
  callback: any,
  callbackError: any,
) => {
...
export const addMemberNetwork: any = (
  data: any,
  callback: any,
  callbackError: any,
) => {
