...
import { GET_INSTITUTIONS_POSTS, GET_INSTITUTIONS_POSTS_FAILED, GET_INSTITUTIONS_POSTS_SUCCESS, GET_INSTITUTION_POSTS, GET_INSTITUTION_POSTS_FAILED, GET_INSTITUTION_POSTS_SUCCESS, GET_INSTITUTION_TEACHERS_LIST, GET_INSTITUTION_TEACHERS_LIST_FAILED, GET_INSTITUTION_TEACHERS_LIST_SUCCESS, GET_MY_INSTITUTIONS, GET_MY_INSTITUTIONS_FAILED, GET_MY_INSTITUTIONS_SUCCESS, GET_ONE_INSTITUTION, GET_ONE_INSTITUTION_FAILED, GET_ONE_INSTITUTION_SUCCESS } from "../types/institutionsActionTypes";
...
export const getInstTeachersList = (
    data: any,
    callback: any,
    callbackError: any
) => {
