...
export const GET_MY_EVENTS_LIST = 'GET_MY_EVENTS_LIST';
export const GET_MY_EVENTS_LIST_SUCCESS = 'GET_MY_EVENTS_LIST_SUCCESS';
export const GET_MY_EVENTS_LIST_FAILED = 'GET_MY_EVENTS_LIST_FAILED';
